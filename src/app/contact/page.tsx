      ...
      <section className="relative pt-32 pb-20 bg-charcoal overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <span className="text-gold text-xs font-semibold uppercase tracking-[0.3em] mb-4 block">Contactez-nous</span>
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-4">Nous sommes &agrave; votre &eacute;coute</h1>
            <p className="text-white/50 max-w-xl mx-auto">
              Une question, une demande sp&eacute;ciale ? N&apos;h&eacute;sitez pas &agrave; nous contacter.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-offwhite">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              <div>
                <h2 className="text-2xl font-serif font-bold text-charcoal mb-6">Nos coordonn&eacute;es</h2>
                <p className="text-charcoal/60 leading-relaxed mb-8">
                  Notre &eacute;quipe est disponible pour r&eacute;pondre &agrave; toutes vos questions
                  concernant nos vins, les commandes ou le retrait.
                </p>
              </div>
            ...
            >
              {submitted ? (
                <div className="bg-white rounded-2xl border border-cream p-12 text-center">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-charcoal mb-3">Message envoy&eacute; !</h3>
                  <p className="text-charcoal/50 mb-6">
                    Nous avons bien re&ccedil;u votre message et vous r&eacute;pondrons dans les meilleurs d&eacute;lais.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-cream p-8">
                  <h3 className="text-xl font-serif font-bold text-charcoal mb-6">&Eacute;crivez-nous</h3>
                  <div className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-sm font-medium text-charcoal/70 mb-1.5">Nom complet</label>
                        <input
                          type="text"
                          required
                          value={form.name}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-charcoal/70 mb-1.5">Message</label>
                      <textarea
                        required
                        rows={6}
                        value={form.message}
